            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color.fromARGB(255, 221, 28, 166), Color.fromARGB(255, 238, 184, 225)],
                ),
              ),
            ),
          ),
        ...
        Opacity(
          ...
          child: ClipPath(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color.fromARGB(255, 229, 142, 219), Color.fromARGB(255, 214, 232, 218)],
                ),
              ),
            ),
          ),
      ...
      child: Row(
        children: <Widget>[
          Text(
            "Welcome",
            style: TextStyle(
              color: Color.fromARGB(255, 226, 161, 203),
      ...
      child: Row(
        children: <Widget>[
          Text(
            ...
            style: TextStyle(
              color: Color.fromARGB(255, 221, 28, 182),
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "Recover",
              style: TextStyle(
                  fontWeight: FontWeight.w600, color:Color.fromARGB(255, 221, 28, 173)),
            ),
          )
        ],
      ),
    ...
    return ElevatedButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: <Color>[Color.fromARGB(255, 221, 28, 179), Color.fromARGB(255, 116, 12, 67)],
          ),
        ),
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "Sign up",
              style: TextStyle(
                  fontWeight: FontWeight.w800, color: Color.fromARGB(255, 221, 28, 160), fontSize: _large? 19: (_medium? 17: 15)),
            ),
          )
        ],
      ),
